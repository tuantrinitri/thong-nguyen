<?php return array (
    ...
    array (
      ...
      array (
        ...
        array (
          'include' => 
          array (
            0 => '/usr/local/ampps/www/thong-nguyen',
          ),
          'exclude' => 
          array (
            0 => '/usr/local/ampps/www/thong-nguyen/.git',
            1 => '/usr/local/ampps/www/thong-nguyen/vendor',
            2 => '/usr/local/ampps/www/thong-nguyen/node_modules',
          ),
          'follow_links' => false,
        ),
        'databases' => 
      ...
      'temporary_directory' => '/usr/local/ampps/www/thong-nguyen/storage/app/backup-temp',
    ),
    'notifications' => 
    array (
      'notifications' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/usr/local/ampps/www/thong-nguyen/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/usr/local/ampps/www/thong-nguyen/storage/app',
      ),
      'upload' => 
      array (
        'driver' => 'local',
        'root' => '/usr/local/ampps/www/thong-nguyen/public/upload',
        'url' => '/upload',
        'visibility' => 'public',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/usr/local/ampps/www/thong-nguyen/storage/app/public',
        'url' => '/storage',
        'visibility' => 'private',
      ),
      's3' => 
  ...
  array (
    ...
    'psr2' => 
    array (
      'standard' => '/usr/local/ampps/www/thong-nguyen/config/../phpcs.xml',
      'ignored' => 
      array (
        0 => '*/database/*',
        1 => '*/public/*',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/usr/local/ampps/www/thong-nguyen/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/usr/local/ampps/www/thong-nguyen/resources/views/vendor/mail',
      ),
    ),
    'log_channel' => NULL,
  ),
  ...
  array (
    ...
    'generator' => 
    array (
      'basePath' => '/usr/local/ampps/www/thong-nguyen/app',
      'rootNamespace' => 'App\\',
      'stubsOverridePath' => '/usr/local/ampps/www/thong-nguyen/app',
      'paths' => 
      array (
        'models' => 'Entities',
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/usr/local/ampps/www/thong-nguyen/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    ...
    'geoip_database_path' => '/usr/local/ampps/www/thong-nguyen/config/geoip',
  ...
  array (
    'paths' => 
    array (
      0 => '/usr/local/ampps/www/thong-nguyen/resources/views',
    ),
    'compiled' => '/usr/local/ampps/www/thong-nguyen/storage/framework/views',
  ),
  'widget' => 
  array (
    'groups' => 
...
',
    ...
    'temporary_files' => 
    array (
      'local_path' => '/usr/local/ampps/www/thong-nguyen/storage/framework/laravel-excel',
      'remote_disk' => NULL,
      'remote_prefix' => NULL,
  ...
  array (
    ...
    'paths' => 
    array (
      0 => '/usr/local/ampps/www/thong-nguyen/public/upload',
      1 => '/usr/local/ampps/www/thong-nguyen/public/images',
    ),
    'templates' => 
    array (

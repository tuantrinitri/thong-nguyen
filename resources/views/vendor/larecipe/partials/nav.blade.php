<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="http://git.mitechcenter.vn/php-developer/core-cms" target="__blank" type="black" class="mx-2 px-4">
            ...
            <larecipe-dropdown>
                <larecipe-button type="white" class="ml-2">
                    {{ auth()->user()->display_name ?? 'Tài khoản' }} <i class="fa fa-angle-down"></i>
                </larecipe-button>

                <template slot="list">
                    <a href="{{ route('user.logout') }}" class="py-2 px-4 text-white bg-danger inline-flex"><i class="fa fa-power-off mr-2"></i> Đăng xuất</a>
                </template>
            </larecipe-dropdown>
            {{-- /account --}}
            @endauth

    ...
    <div class="card-body">
        <form action="{{ route('category.admin.add') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input name="title" id="txtTitle" type="text" class="form-control" placeholder="{{ trans('post::category.title') }}" value="{{ old('title') }}">
            </div>
            <div class="form-group">
                <label><strong>{{ trans('post::category.slug') }}</strong> <sup class="text-danger">(∗)</sup></label>
                <div class="input-group">
                    <input placeholder="{{ trans('post::category.slug') }}" id="txtSlug" type="text" class="form-control" name="slug" value="{{ isset($slug) ? old('slug', $slug) : old('slug') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group areaBrowserFile">
                    <input placeholder="{{ trans('post::category.image') }}" readonly type="text" id="cat-image" class="form-control" name="image" value="{{ old('image') }}">
                    <div class="input-group-prepend mr-0">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" placeholder="{{ trans('post::category.description') }}" rows="3">{{ old('description') }}</textarea>
            </div>
            ...
            <hr>
            <div class="form-group row">
                <label class="col-form-label col-lg-3"><strong>{{ trans('post::category.locale') }}</strong></label>
                <div class="col-lg-9">
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <div class="uniform-choice">
                                <div class="uniform-choice" aria-disabled="">
                                    <input name="locale" type="radio" class="form-check-input-styled" {{ isset($lang) && $lang != 'vi' ? 'disabled' : '' }} {{ isset($lang) && $lang =='vi' ? 'checked' : '' }} value="vi">
                                </div>
                            </div>
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <div class="uniform-choice">
                                <div class="uniform-choice">
                                    <input name="locale" type="radio" class="form-check-input-styled" {{ isset($lang) && $lang =='en' ? 'checked' : '' }} {{ isset($lang) && $lang != 'en' ? 'disabled' : '' }} value="en">
                                </div>
                            </div>

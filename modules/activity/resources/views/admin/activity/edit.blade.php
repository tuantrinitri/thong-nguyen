                ...
                <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input id="txtTitle" name="title" value="{{ old('title', $transtion['title']) }}"
                                    type="text" class="form-control" placeholder="{{ trans('page::admin.title_pla') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input placeholder="{{ trans('page::admin.slug_pla') }}" type="text"
                                        class="form-control" name="link"
                                        value="{{ isset($activity->link) ? old('link', $activity->link) : old('link') }}"
                                        {!! isset($activity->link) ? 'readonly' : '' !!}>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea name="description" rows="4" class="form-control"
                                    placeholder="{{ trans('page::admin.description_pla') }}">{{ old('description', $transtion['description']) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>

...
<div class="p-3">
    <form action="{{ route('activity.admin.edit', $activity['id']) }}" method="post">
        {{ csrf_field() }}
            ...
            <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input id="txtTitle" name="title" value="{{ old('title', $transtion['title']) }}" type="text" class="form-control" placeholder="{{ trans('page::admin.title_pla') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input placeholder="{{ trans('page::admin.slug_pla') }}" type="text" class="form-control" name="link" value="{{ isset( $activity->link) ? old('link',  $activity->link) : old('link') }}" {!! isset( $activity->link) ? 'readonly' : '' !!}>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group areaBrowserFile">
                                <input placeholder="{{ trans('page::admin.illustration_pla') }}" readonly type="text" id="page-image" class="form-control" name="image" value="{{ old('image', $activity['image']) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea name="description" rows="4" class="form-control" placeholder="{{ trans('page::admin.description_pla') }}">{{ old('description', $transtion['description']) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-9" id="choose-lang">
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="locale" type="radio" class="form-check-input-styled" {{ $transtion['locale'] =='vi' ? 'checked' : 'disabled' }} value="vi">
                                        </div>
                                    </div>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="locale" type="radio" class="form-check-input-styled" {{ $transtion['locale'] =='en' ? 'checked' : 'disabled' }} value="en">
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $activity['status']) == 1 ? 'checked' : '' }} value="1">
                                        </div>
                                    </div>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="status" type="radio" class="form-check-input-styled" {{ old('status', $activity['status']) == 0 ? 'checked' : '' }} value="0">
                                        </div>
                                    </div>

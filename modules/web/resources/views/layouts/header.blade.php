                              ...
                              <div class="col">
                                <div class="img-wrap">
                                  <a href="hiking-camping.html"
                                    ><img
                                      src="{{asset('assets/web/img/generic/img-01.jpg')}}"
                                      height="228"
                                      width="350"
                              ...
                              <div class="col">
                                <div class="img-wrap">
                                  <a href="jungle-safari.html"
                                    ><img
                                      src="{{asset('assets/web/img/generic/img-02.jpg')}}"
                                      height="215"
                                      width="370"
                                      alt="image description"
                                  /></a>
                              ...
                              <div class="col">
                                <div class="img-wrap">
                                  <a href="city-tour.html"
                                    ><img
                                      src="{{asset('assets/web/img/generic/img-03.jpg')}}"
                                      height="215"
                                      width="370"
                                      alt="image description"
                                  /></a>
                              ...
                              <div class="col">
                                <div class="img-wrap">
                                  <a href="family-fun.html"
                                    ><img
                                      src="{{asset('assets/web/img/generic/img-04.jpg')}}"
                                      height="215"
                                      width="370"
                                      alt="image description"
                                  /></a>

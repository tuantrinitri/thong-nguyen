                              ...
                              <div class="drop-wrap cart-wrap">
                                  ...
                                  <ul class="cart-list">
                                      <li>
                                          <div class="img">
                                              <a href="#">
                                                  <img src="{{ asset('assets/web/img/listing/img-16.jpg') }}"
                                                      height="165" width="170" alt="image description" />
                                              </a>
                                          </div>
                                      ...
                                      <li>
                                          <div class="img">
                                              <a href="#">
                                                  <img src="{{ asset('assets/web/img/listing/img-17.jpg') }}"
                                                      height="165" width="170" alt="image description" />
                                              </a>
                                          </div>
                                          <div class="text-holder">
                                      ...
                                      <li>
                                          <div class="img">
                                              <a href="#">
                                                  <img src="{{ asset('assets/web/img/listing/img-18.jpg') }}"
                                                      height="165" width="170" alt="image description" />
                                              </a>
                                          </div>
                                          <div class="text-holder">

                        ...
                        <form class="contact-form has-border" id="contact_form" action="#">
                            <fieldset>
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="fname">Họ Tên</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="lname">Email</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="con_email">Điện Thoại</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="con_phone">Địa Chỉ</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="con_country">Tiêu đề</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="con_country">Ngày khởi hành dự
                                                kiến</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <strong class="form-title"><label for="con_message">Nội dung</label></strong>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                            <textarea cols="30" rows="10" class="form-control" id="con_message"
                                ...
                                <div class="form-group btn-holder">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-wrap">
                                            <input type="submit" id="btn_sent" value="Gửi đi" class="btn btn-white" />

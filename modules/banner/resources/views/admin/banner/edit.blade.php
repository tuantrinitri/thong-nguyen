            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <select name="widget_id" class="form-control select2 w300">
                            ...
                            <option value="{{ $widget['id'] }}" {{ (old('widget_id') == $widget['id'] || $banner['widget_id'] == $widget['id']) ? 'selected'  : '' }}>{{ $widget['title'] }}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="datepicker-wrap">
                        <input placeholder="Chọn khoảng thời gian" autocomplete="off" name="available_time" type="text" class="form-control daterange-basic" value="{{ old('available_time', $banner['available_time']) }}">
                    </td>
                </tr>
            </tbody>
        </table>
